...
namespace WLN.Test.Project.Helpers
{
    ...
    public static class Expect
    {
        ...
        /// <summary>
        ///     Throws <see cref="System.ArgumentNullException" /> if the given string argument is null or empty.
        /// </summary>
        /// <param name="argumentValue">String argument value to test.</param>
        /// <param name="argumentName">Name of the argument being tested (optional).</param>
        /// <exception cref="System.ArgumentNullException"><paramref name="argumentValue" /> is null or empty.</exception>
